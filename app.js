// Inicializar Supabase correctamente desde el objeto global
const supabase = window.supabase.createClient(
    "https://ifvxpvotbftwsgmqmdrf.supabase.co",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imlmdnhwdm90YmZ0d3NnbXFtZHJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDY3MTEwOTIsImV4cCI6MjA2MjI4NzA5Mn0._uO3Oqg3pZ5DiQRmrJG5WAms3NOfc6vvOa5yyWshHIE"
  );
  ...
  async function login() {
    ...
    const { data, error } = await supabase
      ...
      .eq("contrasena", password) // corregido: debe coincidir con el nombre real en tu base de datos
      .single();
